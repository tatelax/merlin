	...
	<div class="grid">
		<div class="col-12">
			<div class="card">
				...
				<DataTable :value="sessions" :paginator="true" class="p-datatable-gridlines" :rows="10" dataKey="id" :rowHover="true" 
							v-model:filters="filters1" filterDisplay="menu" :loading="loading1" :filters="filters1" responsiveLayout="scroll"
							:globalFilterFields="['name']" v-model:selection="selectedSession" selectionMode="single" 
                    ...
                    <template #loading>
                        Loading live sessions. Please wait.
                    </template>
