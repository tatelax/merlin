  ...
  <div class="surface-0 overflow-hidden">
    <div
      ...
      <router-link to="/" class="flex align-items-center">
        <img :src="'layout/images/logo-' + logoColor + '.svg'" alt="Sakai Logo" height="50" class="mr-0 lg:mr-2"><span
          class="text-900 font-medium text-2xl line-height-3 mr-8">SAKAI</span>
      </router-link>
      ...
      <div
        ...
        <ul class="list-none p-0 m-0 flex lg:align-items-center select-none flex-column lg:flex-row cursor-pointer">
          ...
          <li>
            <a @click="smoothScroll('#highlight')"
              class="flex m-0 md:ml-5 px-0 py-3 text-900 font-medium line-height-3 p-ripple" v-ripple>
              <span>Highlight</span>
            </a>
          </li>
        ...
        <div
          ...
          <router-link to="/login"><Button label="Login"
    ...
    <div class="grid py-4 px-4 lg:px-8 relative" id="hero">
      <div class="mx-4 md:mx-8 mt-0 md:mt-4">
        ...
        <p class="font-normal text-2xl line-height-3 md:mt-3 text-gray-700">Sed blandit libero volutpat sed cras. Fames
          ac turpis egestas integer. Placerat in egestas erat... </p>
      ...
      <div class="grid justify-content-center">
        ...
        <div class="col-12 mt-8 mb-8 p-2 md:p-8"
          ...
          <div class="flex flex-column justify-content-center align-items-center text-center px-3 py-3 md:py-0">
            ...
            <p class="text-gray-900 sm:line-height-2 md:line-height-4 text-2xl mt-4" style="max-width:800px;">“Duis aute
    ...
    <div class="py-4 px-4 lg:px-8 mx-0 my-6 lg:mx-8" id="highlight">
      ...
      <div class="grid mt-8 pb-2 md:pb-8">
        ...
        <div
          ...
          <div class="flex align-items-center justify-content-center bg-purple-200"
          ...
          <span class="text-700 text-2xl line-height-3 ml-0 md:ml-2" style="max-width:650px;">Lectus arcu bibendum at
            varius vel pharetra vel turpis nunc. Eget aliquet nibh praesent tristique magna sit amet purus gravida. Sit
      ...
      <div class="grid my-8 pt-2 md:pt-8">
        <div class="col-12 lg:col-6 my-auto flex flex-column lg:align-items-start align-items-center">
          <div class="flex align-items-center justify-content-center bg-yellow-200"
            style="width:4.2rem; height:4.2rem; border-radius:10px;">
          ...
          <span class="text-700 text-2xl line-height-3 mr-0 md:mr-2" style="max-width:650px;">Adipiscing commodo elit at
            imperdiet dui. Viverra nibh cras pulvinar mattis nunc sed blandit libero. Suspendisse in est ante in. Mauris
    ...
    <div class="py-4 px-4 lg:px-8 my-2 md:my-4" id="pricing">
      ...
      <div class="grid justify-content-between mt-8 md:mt-0">
        <div class="col-12 lg:col-4 p-0 md:p-3">
          <div class="p-3 flex flex-column border-200 hover:border-cyan-200"
            ...
            <div class="my-5 text-center">
              ...
              <Button label="Get Started"
                class="block mx-auto mt-4 p-button-rounded border-none ml-3 font-light text-white line-height-2 bg-blue-500"></button>
            </div>
      ...
      <div class="grid justify-content-between">
        <div class="col-12 md:col-2" style="margin-top:-1.5rem;">
          <div class="flex flex-wrap align-items-center justify-content-center md:justify-content-start md:mb-0 mb-3">
            <img :src="'layout/images/logo-' + logoColor + '.svg'" alt="footer sections" width="50" height="50"
              class="mr-2">
          ...
          <div class="grid text-center md:text-left">
            ...
            <div class="col-12 md:col-3 mt-4 md:mt-0">
              ...
              <a class="line-height-3 text-xl block cursor-pointer mb-2 text-700">Events<img
                  src="layout/images/new-badge.svg" class="ml-2" /></a>
